...
### `Faker\Provider\Image`
    ...
    image($dir, $width, $height, 'cats', true, true, 'Faker') // 'tmp/13b73edae8443990be1aa8f1a483bc27.jpg' it's a cat with 'Faker' text
    image($dir, $width, $height, 'cats', true, true, 'Faker', 30) // Timeout while waiting for downloading images
