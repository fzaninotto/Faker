...
```
$ ./bin/faker.php --format printf --pattern "INSERT INTO emails (uuid, email) VALUES (UUID(), %s);" --enclosure "'" -c 10 safeEmail
...
```
./bin/faker.php --format vprintf --pattern "INSERT INTO keywords (uuid, keyword1, keyword2, keyword3) VALUES (UUID(), %s, %s, %s);" --enclosure "'" -c 10 words 3
...
```
$ ./bin/faker.php --format printf --pattern "INSERT INTO words (uuid, words) VALUES (UUID(), %s);" --delimiter ', ' --enclosure "'" --count 10 words 10
