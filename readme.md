...
### `Faker\Provider\HtmlLorem`
    ...
    // Generate HTML fragment which is no more than 4 levels deep, and no more than 3 elements wide at any level.
    randomHtmlFragment(4,2)   // <div class="fugiat"></div><div class="sint"><div id="73192"><ul><li>Ea saepe ex.</li><li>Aut repellat.</li><li>Harum blanditiis ut consequatur eius.</li><li>Est tenetur soluta veritatis veniam.</li><li>Vel ut nihil architecto dolor sequi.</li><li>Praesentium cupiditate quasi.</li><li>Repellendus est molestiae.</li><li>Molestiae eius sint porro.</li></ul>Exercitationem consequatur optio.<table><thead><tr><th>Sunt necessitatibus quam totam.</th></tr></thead><tbody><tr><td>Natus voluptatum minima aut provident possimus et ipsam.</td></tr><tr><td>Earum vero ut ut.</td></tr><tr><td>Laboriosam quia consequatur sequi.</td></tr></tbody></table></div><div id="9025"></div></div>
