...
### `Faker\Provider\Gravatar`

    // Gravatar generation provided by Gravatar (https://www.gravatar.com)
    gravatarUrl(string $mode = null, string $email = null, int $size = 80)
    gravatar(string $dir, string $mode = null, string $email = null, int $size = 80)
