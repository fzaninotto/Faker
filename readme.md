...
### `Faker\Provider\Image`
    ...
    image($dir, $width, $height, 'cats', true, true, 'Faker', 30) // Timeout while waiting for downloading images, and a cat with 'Faker' text. (Default, `30` seconds for a timeout & `null` for a text.)
