...
* [pattern-lab/plugin-php-faker](https://github.com/pattern-lab/plugin-php-faker): Adds Faker support to Pattern Lab, a Styleguide, Component Library, and Prototyping tool. The Faker Plugin will create unique content each time Pattern Lab is generated. You can also use the Faker Plugin to provide locale appropriate content.
