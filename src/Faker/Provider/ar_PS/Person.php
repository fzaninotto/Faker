...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        'هنية', 'عباس', 'دحلان', 'الباشا', 'عاشور', 'الشرفا', 'مصبح', 'السطري',
        'الحاج أحمد', 'الصيفي', 'ياسين', 'عزام', 'الهندس', 'الشوا', 'سلامة',
        'حمد', 'الخطيب', 'عودة', 'نصر الله', 'منصور', 'الخالدي', 'شراب', 'شهاب',
        'رشيد', 'مرتجى', 'حمدان', 'أبوزيد', 'الشريف', 'الحداد', 'نعيم', 'الشيخ',
        'جمعة', 'حسان', 'سالم', 'عوض', 'الحجار', 'مطر', 'أبوالخير', 'صلاح',
        'الحلو', 'حمادة', 'عودة'
    );
