...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static $cityName = array('القدس', 'عكا', 'نابلس', 'بيسان', 'صفد', 'طبريا', 'الناصرة', 'حيفا', 'جنين', 'طولكرم', 'الخليل', 'رام الله', 'يافا', 'الرملة', 'غزة', 'بئر السبع', 'عسقلان', 'بيت لحم', 'خان يونس', 'رفح', 'دير البلح');

    /**
     * @link 
     */
    protected static $governorates = array('محافظة أريحا', 'محافظة بئر السبع', 'محافظة بيت لحم', 'محافظة جنين', 'محافظة خان يونس', 'محافظة الخليل', 'محافظة دير البلح', 'محافظة رام الله والبيرة', 'محافظة رام الله والبيرة', 'محافظة سلفيت', 'محافظة طوباس', 'محافظة طولكرم', 'محافظة غزة', 'محافظة القدس', 'محافظة قلقيلية', 'محافظة نابلس');
