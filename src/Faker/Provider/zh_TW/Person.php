...
class Person extends \Faker\Provider\Person
{
     ...
     */
    public static array $idBirthplaceCode = [
        'A' => 10,
        'B' => 11,
        'C' => 12,
        'D' => 13,
     ...
     */
    protected static array $characterMale = [
        '佳',
        '俊',
        '信',
        '偉',
    ...
    protected static array $characterFemale = [
        '伶',
        '佩',
        '佳',
        '依',
    ...
    public static function randomName($pool, $n): string
    {
        $name = '';
        for ($i = 0; $i < $n; ++$i) {
     ...
     */
    public function personalIdentityNumber(?string $gender = null): string
    {
