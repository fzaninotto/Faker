...
class Address extends \Faker\Provider\Address
{
    ...
    public static function randomChineseNumber(): string
    {
        $digits = [
            '',
            '一',
    ...
    public static function randomNumber2(): int
    {
        return static::randomNumber(2) + 1;
    }

    public static function randomNumber3(): int
    {
        return static::randomNumber(3) + 1;
    }

    public static function localLatitude(): string
    {
        return \number_format(\random_int(22000000, 25000000) / 1000000, 6);
    }

    public static function localLongitude(): string
    {
        return \number_format(\random_int(120000000, 122000000) / 1000000, 6);
    }
