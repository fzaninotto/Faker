...
class Internet extends Base
{
    ...
    public function userName(): string
    {
        ...
        if ('' === \trim($username, '._')) {
            throw new \RuntimeException('userName failed with the selected locale. Try a different locale or activate the "intl" PHP extension.');
        }
    ...
    {
        $pattern = \str_repeat('*', self::numberBetween($minLength, $maxLength));
    ...
    public function domainWord(): string
    {
        ...
        // check if transliterate() didn't support the language and removed all letters
        if ('' === \trim($lastName, '._')) {
            throw new \RuntimeException('domainWord failed with the selected locale. Try a different locale or activate the "intl" PHP extension.');
        }
    ...
    {
        return \long2ip(0 === \random_int(0, 1) ? \random_int(-2147483648, -2) : \random_int(16777216, 2147483647));
    }
    ...
    protected static function transliterate($string): string
    {
