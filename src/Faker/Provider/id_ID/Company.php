...
class Company extends \Faker\Provider\Company
{
    protected static $formats = array(
        '{{companyPrefix}} {{firstNameMale}} {{companySuffix}}',
        '{{companyPrefix}} {{firstNameFemale}} {{companySuffix}}',
        '{{firstNameMale}} {{companySuffix}}',
        '{{firstNameFemale}} {{companySuffix}}'
    );
    ...
    protected static $companyPrefix = array('PT', 'CV', 'PO', 'UD');
    protected static $companySuffix = array('Sentosa', 'Abadi', 'Purnama', 'Group', 'Sari', 'Swadaya', 'Cattery', 'Poultry', 'Pet Shop', 'Market', 'Indonusa');
