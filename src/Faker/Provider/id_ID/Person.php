...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = array(
        ...
        'Empluk', 'Endra', 'Enteng', 'Estiawan', 'Estiono', 'Eko',
        ...
        'Gambira', 'Gamblang', 'Ganda', 'Gandewa', 'Gandi', 'Ganep',
        'Gangsa', 'Gangsar', 'Ganjaran', 'Gantar', 'Gara', 'Garan', 'Garang',
        'Garda', 'Gatot', 'Gatra', 'Gilang', 'Ghani', 'Gading',
    ...
    protected static $firstNameFemale = array(
        ...
        'Pia', 'Puspa', 'Puti', 'Padmi', 'Qori', 'Queen', 'Ratih',
        'Ratna', 'Restu', 'Rini', 'Rika', 'Rina', 'Rahayu', 'Rahmi', 'Rachel', 'Raisa', 'Raina', 'Sarah', 'Sari', 'Siti', 'Siska', 'Suci',
    ...
    protected static $lastNameMale = array(
        ...
        'Sihombing', 'Salahudin', 'Samosir', 'Saragih', 'Sihotang',
        'Simanjuntak', 'Sinaga', 'Simbolon', 'Sitompul', 'Sitorus', 'Sirait', 'Situmorang', 'Tampubolon', 'Thamrin', 'Tamba', 'Tarihoran',
