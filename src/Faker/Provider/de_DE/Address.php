...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $country = array(
        ...
        'Vanuatu', 'Vatikanstadt', 'Venezuela', 'Vereinigte Arabische Emirate', 'USA', 'Vereinigtes Königreich', 'Vietnam',
