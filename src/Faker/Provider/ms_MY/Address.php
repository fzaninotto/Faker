...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static array $buildingPrefix = [
        '',
        '',
        '',
        '',
    ...
    protected static array $townshipFormats = [
     ...
     */
    protected static array $townshipPrefixAbbr = [
        'SS',
        'Seksyen ',
        'PJS',
        'PJU',
     ...
     */
    protected static array $townshipPrefix = [
        'Alam',
        'Apartment',
        'Ara',
        'Bandar',
    ...
    protected static array $townshipSuffix = [
        'Aman',
        'Amanjaya',
        'Anggerik',
        'Angkasa',
     ...
     * @example 'No.'
     */
    public static function buildingPrefix(): string
    {
     ...
     */
    public function township(): string
    {
     ...
     * @example 'USJ'
     */
    public function townshipPrefixAbbr(): string
    {
     ...
     * @example 'Taman'
     */
    public function townshipPrefix(): string
    {
     ...
     * @example 'Bahagia'
     */
    public function townshipSuffix(): string
    {
     ...
     */
    public static function postcode(?string $state = null): string
    {
        $format = [
            'perlis' => [ // (01000 - 02800)
     ...
     */
    public function townState(): string
    {
