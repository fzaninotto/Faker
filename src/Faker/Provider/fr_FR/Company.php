...
class Company extends \Faker\Provider\Company
{
     ...
     */
    protected static array $companySuffix = ['SA', 'S.A.', 'SARL', 'S.A.R.L.', 'SAS', 'S.A.S.', 'et Fils'];

    protected static array $siretNicFormats = ['####', '0###', '00#%'];
    ...
    public function catchPhrase(): string
    {
        while (true) {
            ...
            if (self::isCatchPhraseValid($catchPhrase)) {
                break;
            }
        }
     ...
     */
    public static function siren($formatted = true): string
    {
        $siren = self::numerify('%#######');
     ...
     */
    protected static array $wordsWhichShouldNotAppearTwice = ['sécurité', 'simpl'];
     ...
     */
    protected static function isCatchPhraseValid(string $catchPhrase): bool
    {
        foreach (static::$wordsWhichShouldNotAppearTwice as $word) {
            ...
            if (false !== $beginPos && $beginPos !== $endPos) {
                return false;
            }
        }
