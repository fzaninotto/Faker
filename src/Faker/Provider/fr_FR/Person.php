...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $titleMale = ['M.', 'Dr.', 'Pr.', 'Me.'];

    protected static array $titleFemale = ['Mme.', 'Mlle', 'Dr.', 'Pr.', 'Me.'];

    protected static array $prefix = ['de', 'de la', 'Le', 'du'];
     ...
     */
    public function nir($gender = null, $formatted = false): string
    {
        // Gender
        ...
        $nir .=
            ...
            self::numerify('##').
            // Mont of birth (mm)
            \sprintf('%02d', self::numberBetween(1, 12));
        ...
        if (2 === \strlen($department)) {
            $nir .= self::numerify('###');
        } elseif (3 === \strlen($department)) {
            $nir .= self::numerify('##');
        }
        ...
        if ($formatted) {
            $nir = \substr($nir, 0, 1).' '.\substr($nir, 1, 2).' '.\substr($nir, 3, 2).' '.\substr($nir, 5, 2).' '.\substr($nir, 7, 3).' '.\substr(
                $nir,
                10,
                3
            ).' '.\substr($nir, 13, 2);
