...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $cityName = array(
        ...
        'الدوادمي', 'الأفلاج','الشرقية','الغربية','طنطا','الدقهلية','منيا القمح','بور سعيد','بور فؤاد','السويس','الاسماعيلية','الزقازيق','القاهرة',
        'الإسكندرية','أسيوط','سوهاج','قنا','دور الزور','دمشق','بيروت',
    );
