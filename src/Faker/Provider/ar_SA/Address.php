...
{
    protected static array $cityPrefix = ['شرق'];

    protected static array $streetPrefix = ['شارع', 'طريق', 'ممر'];
     ...
     */
    protected static array $governorates = [
        'الرياض',
        'الدرعية',
        'الخرج',
        'الدوادمي',
    ...
    protected static array $secondaryAddressFormats = ['شقة رقم. ##', 'عمارة رقم ##'];
