...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $citySuffix = array('টাউন', 'তলা', 'হাট', 'খানা','বাজার');

    protected static $streetNames = array(
        'বরকত', 'হাজী', 'করিমউদ্দিন','শওকত জং','কামালউদ্দিন','জাহাঙ্গীর'
    );
    ...
    protected static $state = array(
        'খুলনা', 'বরিশাল', 'চিটাগং', 'ঢাকা',
		'রাজশাহী', 'সিলেট', 'কুমিল্লা','ভোলা','ঝালকাঠি','পটূয়াখালি','পিরোজপুর',
		'ব্রাহ্মণবাড়িয়া', 'বান্দরবান', 'চাদপুর','ময়মনসিংহ','নারায়নগঞ্জ','নরসিনদি','রাজবাড়ি',
		'শরিয়তপুর', 'শেরপুর', 'টাঙ্গাইল','বাগেরহাট','চুয়াডাংগা','যশোর','কক্সবাজার','ফেনী',
		'খাগরাছড়ি', 'লক্ষিপুর', 'রাঙামাটি','নোয়াখালি','মৌলভিবাজার','সুনামগঞ্জ','ঝিনাইদহ','কুষ্টিয়া',
		'মাগুরা', 'বগুড়া', 'সাতক্ষিরা','মেহেরপুর','নড়াইল','দিনাজপুর','গাইবান্দা','জয়পুরহাট',
		'কুড়িগ্রাম', ' মাদারীপুর', 'জামাল্পুর','কিশোরগঞ্জ','গোপালগঞ্জ','মুন্সিগঞ্জ','নায়ায়ণগঞ্জ','নীলফামারী',
		'নোয়াবগঞ্জ','পাবনা','পঞ্চগড়'
    );
