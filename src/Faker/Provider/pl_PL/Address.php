...
class Address extends \Faker\Provider\Address
{
    ...
    /**
     * @var array full list o Polish counties
     * @link http://stat.gov.pl/cps/rde/xbcr/bip/BIP_oz_wykaz_identyfikatorow.pdf
     */
    protected static $county = array(
        'dolnośląskie' => array(
            'bolesławiecki', 'dzierżoniowski', 'górowski', 'głogowski', 'jaworski', 'Jelenia Góra', 'jeleniogórski',
            'kamiennogórski', 'kłodzki', 'Legnica', 'legnicki', 'lubański', 'lubiński', 'lwówecki', 'milicki', 'oleśnicki',
            'oławski', 'polkowicki', 'strzeliński', 'trzebnicki', 'Wałbrzych', 'wałbrzyski', 'wołowski', 'Wrocław',
            'wrocławski', 'zgorzelecki', 'ząbkowicki', 'złotoryjski', 'średzki', 'świdnicki'
        ),
        'kujawsko-pomorskie' => array(
            'aleksandrowski', 'brodnicki', 'bydgoski', 'Bydgoszcz', 'chełmiński', 'golubsko-dobrzyński', 'Grudziądz',
            'grudziądzki', 'inowrocławski', 'lipnowski', 'mogileński', 'nakielski', 'radziejowski', 'rypiński',
            'sępoleński', 'Toruń', 'toruński', 'tucholski', 'wąbrzeski', 'Włocławek', 'włocławski', 'świecki', 'żniński'
        ),
        'lubelskie' => array(
            'bialski', 'Biała Podlaska', 'biłgorajski', 'Chełm', 'chełmski', 'hrubieszowski', 'janowski', 'krasnostawski',
            'kraśnicki', 'lubartowski', 'lubelski', 'Lublin', 'opolski', 'parczewski', 'puławski', 'radzyński', 'rycki',
            'tomaszowski', 'włodawski', 'zamojski', 'Zamość', 'łukowski', 'łęczyński', 'świdnicki'
        ),
        'lubuskie' => array(
            'gorzowski', 'Gorzów Wielkopolski', 'krośnieński', 'międzyrzecki', 'nowosolski', 'strzelecko-drezdenecki',
            'sulęciński', 'słubicki', 'wschowski', 'Zielona Góra', 'zielonogórski', 'świebodziński', 'żagański', 'żarski'
        ),
        'łódzkie' => array(
            'bełchatowski', 'brzeziński', 'kutnowski', 'opoczyński', 'pabianicki', 'pajęczański', 'piotrkowski',
            'Piotrków Trybunalski', 'poddębicki', 'radomszczański', 'rawski', 'sieradzki', 'Skierniewice', 'skierniewicki',
            'tomaszowski', 'wieluński', 'wieruszowski', 'zduńskowolski', 'zgierski', 'Łódź', 'łaski', 'łowicki',
            'łódzki wschodni', 'łęczycki'
        ),
        'małopolskie' => array(
            'bocheński', 'brzeski', 'chrzanowski', 'dąbrowski', 'gorlicki', 'krakowski', 'Kraków', 'limanowski',
            'miechowski', 'myślenicki', 'nowosądecki', 'nowotarski', 'Nowy Sącz', 'olkuski', 'oświęcimski', 'proszowicki',
            'suski', 'tarnowski', 'Tarnów', 'tatrzański', 'wadowicki', 'wielicki'
        ),
        'mazowieckie' => array(
            'białobrzeski', 'ciechanowski', 'garwoliński', 'gostyniński', 'grodziski', 'grójecki', 'kozienicki',
            'legionowski', 'lipski', 'makowski', 'miński', 'mławski', 'nowodworski', 'ostrowski', 'ostrołęcki',
            'Ostrołęka', 'otwocki', 'piaseczyński', 'pruszkowski', 'przasnyski', 'przysuski', 'pułtuski', 'Płock',
            'płocki', 'płoński', 'Radom', 'radomski', 'Siedlce', 'siedlecki', 'sierpecki', 'sochaczewski', 'sokołowski',
            'szydłowiecki', 'Warszawa', 'warszawski zachodni', 'wołomiński', 'wyszkowski', 'węgrowski', 'zwoleński',
            'łosicki', 'żuromiński', 'żyrardowski'
        ),
        'opolskie' => array(
            'brzeski', 'głubczycki', 'kluczborski', 'krapkowicki', 'kędzierzyńsko-kozielski', 'namysłowski', 'nyski',
            'oleski', 'Opole', 'opolski', 'prudnicki', 'strzelecki'
        ),
        'podkarpackie' => array(
            'bieszczadzki', 'brzozowski', 'dębicki', 'jarosławski', 'jasielski', 'kolbuszowski', 'Krosno', 'krośnieński',
            'leski', 'leżajski', 'lubaczowski', 'mielecki', 'niżański', 'przemyski', 'Przemyśl', 'przeworski',
            'ropczycko-sędziszowski', 'rzeszowski', 'Rzeszów', 'sanocki', 'stalowowolski', 'strzyżowski', 'Tarnobrzeg',
            'tarnobrzeski', 'łańcucki'
        ),
        'podlaskie' => array(
            'augustowski', 'białostocki', 'Białystok', 'bielski', 'grajewski', 'hajnowski', 'kolneński', 'moniecki',
            'sejneński', 'siemiatycki', 'sokólski', 'suwalski', 'Suwałki', 'wysokomazowiecki', 'zambrowski', 'Łomża',
            'łomżyński'
        ),
        'pomorskie' => array(
            'bytowski', 'chojnicki', 'człuchowski', 'Gdańsk', 'gdański', 'Gdynia', 'kartuski', 'kościerski', 'kwidzyński',
            'lęborski', 'malborski', 'nowodworski', 'pucki', 'Sopot', 'starogardzki', 'sztumski', 'Słupsk', 'słupski',
            'tczewski', 'wejherowski'
        ),
        'śląskie' => array(
            'bielski', 'Bielsko-Biała', 'bieruńsko-lędziński', 'Bytom', 'będziński', 'Chorzów', 'cieszyński',
            'Częstochowa', 'częstochowski', 'Dąbrowa Górnicza', 'Gliwice', 'gliwicki', 'Jastrzębie-Zdrój', 'Jaworzno',
            'Katowice', 'kłobucki', 'lubliniecki', 'mikołowski', 'myszkowski', 'Mysłowice', 'Piekary Śląskie', 'pszczyński',
            'raciborski', 'Ruda Śląska', 'rybnicki', 'Rybnik', 'Siemianowice Śląskie', 'Sosnowiec', 'tarnogórski',
            'Tychy', 'wodzisławski', 'Zabrze', 'zawierciański', 'Świętochłowice', 'Żory', 'żywiecki'
        ),
        'świętokrzyskie' => array(
            'buski', 'jędrzejowski', 'kazimierski', 'Kielce', 'kielecki', 'konecki', 'opatowski', 'ostrowiecki',
            'pińczowski', 'sandomierski', 'skarżyski', 'starachowicki', 'staszowski', 'włoszczowski'
        ),
        'warmińsko-mazurskie' => array(
            'bartoszycki', 'braniewski', 'działdowski', 'Elbląg', 'elbląski', 'ełcki', 'giżycki', 'gołdapski', 'iławski',
            'kętrzyński', 'lidzbarski', 'mrągowski', 'nidzicki', 'nowomiejski', 'olecki', 'Olsztyn', 'olsztyński',
            'ostródzki', 'piski', 'szczycieński', 'węgorzewski'
        ),
        'wielkopolskie' => array(
            'chodzieski', 'czarnkowsko-trzcianecki', 'gnieźnieński', 'gostyński', 'grodziski', 'jarociński', 'kaliski',
            'Kalisz', 'kolski', 'Konin', 'koniński', 'kościański', 'krotoszyński', 'kępiński', 'leszczyński', 'Leszno',
            'międzychodzki', 'nowotomyski', 'obornicki', 'ostrowski', 'ostrzeszowski', 'pilski', 'pleszewski', 'Poznań',
            'poznański', 'rawicki', 'szamotulski', 'słupecki', 'turecki', 'wolsztyński', 'wrzesiński', 'wągrowiecki',
            'złotowski', 'średzki', 'śremski'
        ),
        'zachodniopomorskie' => array(
            'białogardzki', 'choszczeński', 'drawski', 'goleniowski', 'gryficki', 'gryfiński', 'kamieński', 'Koszalin',
            'koszaliński', 'kołobrzeski', 'myśliborski', 'policki', 'pyrzycki', 'stargardzki', 'Szczecin', 'szczecinecki',
            'sławieński', 'wałecki', 'łobeski', 'Świnoujście', 'świdwiński'
        )
    );
    /**
    ...
    public function county($state = null)
    {
        $stateKey = $state ?: static::randomKey(static::$county);
        return static::randomElement(static::$county[$stateKey]);
    }
}
