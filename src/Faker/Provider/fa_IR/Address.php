...
{
    protected static array $cityPrefix = ['استان'];
    protected static array $streetPrefix = ['خیابان'];
    protected static array $buildingNamePrefix = ['ساختمان'];
    protected static array $buildingNumberPrefix = ['پلاک', 'قطعه'];
    protected static array $postcodePrefix = ['کد پستی'];

    protected static array $cityName = [
        'آذربایجان شرقی',
        'آذربایجان غربی',
        'اردبیل',
        'اصفهان',
    ...
    protected static array $buildingFormat = [
    ...
    protected static array $country = ['ایران'];
