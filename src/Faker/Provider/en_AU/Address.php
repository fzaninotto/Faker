...
{
    protected static array $cityPrefix = ['North', 'East', 'West', 'South', 'New', 'Lake', 'Port', 'St.'];

    protected static array $buildingNumber = ['###', '##', '#'];

    protected static array $buildingLetters = ['A', 'B', 'C', 'D'];
     ...
     * @example B
     */
    public static function buildingLetter(): string
    {
