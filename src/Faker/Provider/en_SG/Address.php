...
class Address extends \Faker\Provider\Address
{
    ...
    protected static array $streetNumber = ['##', '###'];

    // http://en.wikipedia.org/wiki/Singapore_Post#Address_format
    protected static array $blockNumber = [
        'Blk ##',
        'Blk ###',
        'Blk ###A',
        'Blk ###B',
    ...
    protected static array $streetName = [
        'Adam',
        'Airport',
        'Alexandra',
        'Aljunied',
    ...
    protected static array $floorNumber = [
        '##',
        '0#',
    ];
    ...
    protected static string $townName = 'SINGAPORE';
