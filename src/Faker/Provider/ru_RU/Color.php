...
class Color extends \Faker\Provider\Color
{
    ...
    protected static $allColorNames = array(
        ...
        'Сиена жжёная', 'Хаки', 'Кардинал', 'Морковный', 'Каштановый', 'Шоколадный', 'Коричный',
        'Кобальт синий', 'Кремовый', 'Циан', 'Индиго', 'Фуксия', 'Кирпичный', 'Льняной', 'Золотой', 'Зелёный', 'Нефритовый', 'Сиреневый', 'Охра', 'Панг', 'Берлинская лазурь', 'Красновато-коричневый',
