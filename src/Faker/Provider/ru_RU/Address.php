...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $city = array(
        ...
        'Чехов', 'Шатура', 'Шаховская', 'Щёлково', 'Благовещенск', 'Владивосток', 
        'Иркутск', 'Хабаровск', 'Чита', 'Белогорск', 'Красноярск', 'Находка', 
        'Смоленск', 'Самара', 'Казань', 'Бийск', 'Магнитогорск', 'Томск', 
        'Пермь', 'Южно-сахалинск', 'Челябинск', 'Нижний Новгород', 'Волгоград', 
        'Архангельск', 'Воронеж', 'Абакан', 'Омск-ПГР', 'Нижневартовск', 
        'Сургут', 'Курган', 'Барнаул', 'Тюмень', 'Улан-Удэ', 'Вологда', 
        'Ачинск', 'Кемерово', 'Ярославль', 'Орел', 'Новокузнецк', 'Братск', 
        'Усть-Илимск', 'Рубцовск', 'Биробиджан', 'Рязань', 'Краснодар', 
        'Ставрополь', 'Ростов-на-Дону', 'Астрахань', 'Ижевск', 'Липецк', 
        'Чебоксары', 'Кострома', 'Таганрог', 'Уфа', 'Тверь', 'Тольятти', 
        'Новороссийск', 'Йошкар-Ола', 'Ноябрьск', 'Якутск', 'Набережные Челны', 
        'Нерюнгри', 'Пенза', 'Глазов', 'Сочи', 'Стерлитамак', 'Березники', 
        'Белгород', 'Курск', 'Саратов', 'Пятигорск', 'Новый Уренгой', 
        'Ханты-Мансийск', 'Нефтекамск', 'Оренбург', 'Альметьевск', 'Волжский', 
        'Армавир', 'Тамбов', 'Балаково', 'Иваново', 'Саранск', 'Брянск', 
        'Чайковский', 'Тула', 'Калуга', 'Владимир', 'Ульяновск', 'Магадан', 
        'Энгельс', 'Нижний Тагил', 'Миасс', 'Петрозаводск', 'Орск', 'Мурманск', 
        'Череповец', 'Сыктывкар', 'Великий Новгород', 'Майкоп', 'Псков', 
        'Сарапул', 'Уссурийск', 'Махачкала', 'Елец', 'Лабытнанги', 'Северодвинск', 
        'Шахты', 'Салават', 'Сызрань', 'Шарья', 'Старый Оскол', 'Нальчик', 'Клинцы', 
        'Златоуст', 'Волгодонск', 'Ахтубинск', 'Алматы', 'Димитровград', 'Воркута', 
        'Иваново-Профи', 'Карасук', 'Москва-Северный', 'Пушкино', 'Симферополь', 
        'Иваново-Рио', 'Севастополь', 'Инта', 'Владикавказ', 'Когалым', 'Грозный', 
        'Воскресенск', 'Куйбышев', 'Новая Чара', 'Хасавюрт', 'Кинешма', 'Клин', 
        'Выборг', 'Назрань', 'Кропоткин', 'Ишим', 'Каменск-Шахтинский', 'Донецк', 
        'Екатеринбург', 'Евпатория', 'Керчь', 'Феодосия', 'Ялта', 'Муравленко', 
        'Людиново', 'Бузулук', 'Горно-Алтайск', 'Лангепас', 'Надым', 'Дербент', 
        'Наро-Фоминск', 'Ухта', 'Рыбинск', 'Балашов', 'Москва-Картино', 'Бугуруслан', 
        'Усть-Кут', 'Таксимо', 'Северобайкальск', 'Губкинский', 'Невинномысск', 
        'Тихорецк', 'Лабинск', 'Соликамск', 'Чусовой', 'Магас', 'Коломна', 'Элиста', 
        'Каменск-Уральский', 'Кумертау', 'Кызыл', 'Таштагол', 'Урай', 'Мичуринск', 
        'Вязьма', 'Обнинск', 'Вышний Волочек', 'Мелеуз', 'Новый Оскол', 'Вятские Поляны', 
        'Губкин', 'Воткинск', 'Грязи', 'Черемхово', 'Нурлат', 'Ленинск-Кузнецкий', 
        'Камень-на-Оби', 'Озерск', 'Волхов', 'Югорск', 'Лесосибирск', 'Колпашево', 
        'Усть-Лабинск', 'Кизляр', 'Пангоды', 'Новозыбков', 'Михайловка', 'Выкса', 
        'Тобольск',
    );

    protected static $street = array(
        'Косиора', 'Ладыгина', 'Ленина', 'Ломоносова', 'Домодедовская', 'Гоголя', '1905 года', 'Чехова', 'Сталина',
        'Космонавтов', 'Гагарина', 'Славы', 'Бухарестская', 'Будапештсткая', 'Балканская', 'Советская', 'Красная'
    );
