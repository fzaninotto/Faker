...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $city = array(
        ...
        'Абакан', 'Альметьевск', 'Арзамас', 'Армавир', 'Артём', 'Ачинск', 'Батайск', 'Бердск', 'Березники', 'Волгодонск',
        'Дербент', 'Димитровград', 'Долгопрудный', 'Евпатория', 'Елец', 'Ессентуки', 'Жуковский', 'Златоуст',
        'Каменск-Уральский', 'Камышин', 'Каспийск', 'Керчь', 'Кисловодск', 'Ковров', 'Копейск', 'Красногорск',
        'Кызыл', 'Майкоп', 'Миасс', 'Муром', 'Назрань', 'Находка', 'Невинномысск', 'Нефтекамск', 'Нефтеюганск',
        'Новокуйбышевск', 'Новомосковск', 'Новочебоксарск', 'Новочеркасск', 'Новошахтинск', 'Новый Уренгой',
        'Норильск', 'Ноябрьск', 'Обнинск', 'Октябрьский', 'Первоуральск', 'Петропавловск-Камчатский', 'Пятигорск',
        'Рубцовск', 'Рыбинск', 'Салават', 'Северодвинск', 'Северск', 'Сызрань', 'Уссурийск', 'Хасавюрт',
        'Черкесск', 'Электросталь', 'Элиста'
    );
    ...
    protected static $street = array(
        ...
        'Советов', 'Черненко', 'Кутателадзе', 'Инженеров', 'Комсомольцев',
        'Павлова', 'Пролетариев', 'Рогачёва', 'Демешко', 'Спартака', 'Урицкого', '5-ого МОПРа',
        'Красных сибиряков', '8 Марта', 'Некрасова', 'Маяковского', 'Горького', 'Суворова',
        'Кутузова', 'Свердлова', 'Маркса', 'Ушакова', 'Пушкина', 'Радищева', 'Герцена',
        'Кирова', 'Мусоргского', 'Шнитке', 'Шостаковича', 'Астафьева', 'Попова',
        'Железнодорожников', 'Съезда профсоюзов', 'Тимирязева', 'Дзержинского',
        'Молодой Гвардии', 'Шевченко', 'Матросова', 'Мальцева', 'Воеводского', 'Терешковой',
        'Ильича', 'Правды', 'Ляпунова', 'Пирогова', 'Лаврентьева', 'Ветеранов', 'Академика Будкера',
        'Николаева', 'Трубникова', 'Калинина', 'Мусы Джалиля', 'Молодежи', 'Героев Труда',
        'Арбузова', 'Иванова', 'Тухачевского', 'Одоевского', 'Марата 2-ая', 'Марата',
        'Героев Революции', 'Пожарского', 'Чапаева', 'Шмидта', 'Андреева'
    );
