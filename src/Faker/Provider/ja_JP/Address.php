...
class Address extends \Faker\Provider\Address
{
    ...
    protected static array $prefecture = [
        '北海道',
        '青森県',
        '岩手県',
        '宮城県',
    ...
    protected static array $ward = ['中央', '北', '東', '南', '西'];

    protected static array $citySuffix = ['市'];
    protected static array $wardSuffix = ['区'];
    protected static array $streetSuffix = ['町'];

    protected static array $postcodeFormats = ['{{postcode1}}{{postcode2}}'];
     ...
     * @example 111
     */
    public static function postcode1(): int
    {
     ...
     * @example 2222
     */
    public static function postcode2(): int
    {
     ...
     * @example '北区'
     */
    public static function ward(): string
    {
     ...
     * 丁、番地、号.
     */
    public static function areaNumber(): int
    {
