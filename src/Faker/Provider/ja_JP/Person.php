...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $firstKanaNameFormat = [
        '{{firstKanaNameMale}}',
        '{{firstKanaNameFemale}}',
    ];

    protected static array $maleKanaNameFormats = [
        '{{lastKanaName}} {{firstKanaNameMale}}',
    ];

    protected static array $femaleKanaNameFormats = [
        '{{lastKanaName}} {{firstKanaNameFemale}}',
    ];

    protected static array $firstKanaNameMale = [
        'アキラ',
        'アツシ',
        'オサム',
        'カズヤ',
    ...
    protected static array $firstKanaNameFemale = [
        'アケミ',
        'アスカ',
        'カオリ',
        'カナ',
    ...
    protected static array $lastKanaName = [
        'アオタ',
        'アオヤマ',
        'イシダ',
        'イダカ',
