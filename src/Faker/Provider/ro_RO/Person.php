...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $titleMale = ['dl.', 'ing.', 'dr.'];
    protected static array $titleFemale = ['d-na.', 'd-șoara', 'ing.', 'dr.'];

    protected static array $cnpCountyCodes = [
        'AB' => '01',
        'AR' => '02',
        'AG' => '03',
        'B' => '40',
     ...
     */
    public function cnp(?string $gender = null, ?string $dateOfBirth = null, ?string $county = null, ?bool $isResident = true): string
    {
        ...
        $cnp = self::getGenderDigit($date, $gender, $isResident)
            .$date->format('ymd')
            .$countyCode
            .static::numerify('##%');
    ...
    protected function getDateOfBirth($dateOfBirth): \DateTime
    {
     ...
     */
    protected static function getGenderDigit(\DateTime $dateOfBirth, string $gender, bool $isResident): int
    {
        if (!$isResident) {
            return 9;
        }
     ...
     *
     * @return int|float checksum digit
     */
    protected function getChecksumDigit(string $value): float|int
    {
