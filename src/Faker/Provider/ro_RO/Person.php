...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameFemale = array(
        ...
        'Roxelana', 'Ruxanda', 'Ruxandra', 'Sabina', 'Sabrina', 'Safta', 'Salomea', 'Sanda', 'Saveta', 'Savina', 'Sânziana|Sânziana', 'Semenica', 'Severina', 'Sidonia', 'Silvia', 'Silvana', 'Silviana',
    ...
    //TODO: get more from ottomotor
    protected static $lastName = array(
        'Albu', 'Barbu', 'Boariu', 'Chișu', 'Constantin', 'Cristea', 'Crișan', 'Diaconescu', 'Diaconu', 'Dinu', 'Dobre', 'Dochioiu', 'Dragomir',
        'Dumitrescu', 'Dumitru', 'Ene', 'Florea', 'Georgescu', 'Gheorghe', 'Ghiță', 'Ionescu', 'Ioniță', 'Jivoin',
        'Manole', 'Marin', 'Matei', 'Mazilescu', 'Mihai', 'Mocanu', 'Muntean', 'Nemeș', 'Nistor', 'Oprea', 'Pop', 'Popa', 'Popescu', 'Radu', 'Stan', 'Stoica',
        'Tabacu', 'Toma', 'Tudor', 'Vasile', 'Voinea', 'Șerban', 'Ștefan'
    );
