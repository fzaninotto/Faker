...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = array(
        ...
        'Parveen', 'Pravin', 'Pranab', 'Prabhat', 'Pradeep', 'Prasoon', 'Preet', 'Pranay', 'Parvez', 'Pirzada', 'Peter', 'Purusothaman',
        'Omar', 'Obaid', 'Owais',
        'Qabeel', 'Qabool', 'Qadim',
    ...
    protected static $firstNameFemale = array(
        'Aabha', 'Aarti', 'Aarushi', 'Aastha', 'Aathira', 'Aayushi', 'Abitha', 'Abirami', 'Aditi', 'Afreen', 'Aisha', 'Aishwarya', 'Akanksha', 'Akhila', 'Alaknanda', 'Alka', 'Alagupriya', 'Alpa', 'Anshu', 'Ambika', 'Ananya', 'Ambika', 'Amrita', 'Amolika', 'Anjana', 'Anjali', 'Annalakshmi', 'Annapoorni', 'Ankita', 'Anshula', 'Anterleena', 'Anusha', 'Anupama', 'Aruna', 'Astha', 'Avantika',
        'Babita', 'Basanti', 'Bagwati', 'Bhaagyasree', 'Bhairavi', 'Bhanupriya', 'Binita', 'Bimla', 'Boomika', 'Brindha',
        'Chameli', 'Charu', 'Chhavi', 'Chitra', 'Chhaya', 'Chandni',
        'Damini', 'Devika', 'Dipti', 'Divya', 'Drishti', 'Diya', 'Devi', 'Deepika', 'Durga',
        'Esha', 'Eashwari',
        'Falguni', 'Farah', 'Fatima',
        'Gayatri', 'Geetanjali', 'Gowri', 'Gulab', 'Gunjan', 'Ganga', 'Gurudevi',
        'Harini', 'Heena', 'Heer', 'Hema', 'Himani', 'Hira', 'Hina',
        'Indrani', 'Isha', 'Indira',
        'Jagruti', 'Jasmin', 'Jayshree', 'Jiya', 'Juhi', 'Jyoti', 'Julie', 'Janani',
        'Kalpana', 'Kalavathi', 'Kalyani', 'Kalavathi', 'Kalaiselvi', 'Kamini', 'Kanchana', 'Kasturi', 'Kaveri', 'Kavitha', 'Kavipriya', 'Kiran', 'Komal', 'Kusum', 'Krishna', 'Kanika', 'Kasturba', 'Kunti', 'Kajal', 'Kajol', 'Kirti', 'Kim', 'Kasthuri',
        'Lata', 'Lalita', 'Lavanya', 'Leela', 'Leelawati', 'Lakshmi', 'Laveena',
        'Madhu', 'Madhavi', 'Manjeet', 'Maya', 'Mayawati', 'Megha', 'Mona', 'Mridula', 'Mukti', 'Meghana', 'Manjari', 'Muthumari', 'Mukti', 'Mini', 'Munni', 'Monica',
        ...
        'Padama', 'Padma', 'Padmini', 'Payal', 'Poonam', 'Poornima', 'Prabha', 'Priya', 'Priyanka', 'Pushpa', 'Pooja', 'Prerna', 'Pamela', 'Pinky', 'Parminder', 'Preshita',
        'Radha', 'Radhika', 'Ragini', 'Rakhi', 'Ramya', 'Richa', 'Riddhi', 'Ritika', 'Riya', 'Rohini', 'Roma', 'Ruchi', 'Rachel', 'Rita', 'Rosey', 'Rimi', 'Runjhun',
        'Sabina', 'Sameera', 'Sameedha', 'Sangeetha', 'Saranya', 'Saraswathi', 'Sapna', 'Sara', 'Seema', 'Shanti', 'Sheetal', 'Shobha', 'Savita', 'Simaran', 'Smriti', 'Simi', 'Sivagami', 'Sneha', 'Sona', 'Sonya', 'Soumya', 'Subha', 'Sunita', 'Supriya', 'Sushmita', 'Swati', 'Sweta', 'Shweta', 'Sukriti', 'Swastika', 'Selvi', 'Soundarya',
        'Tamilsevi', 'Tanuja', 'Tejaswani', 'Thilagavathi', 'Tulsi', 'Trishana', 'Teena',
        'Uma', 'Umayal', 'Urmi', 'Urmila', 'Urvashi', 'Usha', 'Upasana',
        'Vineeta', 'Vimala', 'Veena', 'Vaishali', 'Vilashini',
        'Yamini', 'Yasmin', 'Yamuna',
        'Zeenat', 'Zara',
    );
