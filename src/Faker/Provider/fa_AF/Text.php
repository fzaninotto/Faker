...
class Text extends \Faker\Provider\Text
{
    ...
    public function realText($maxNbChars = 200, $indexSize = 2)
    {
        ...
        while ($resultLength < $maxNbChars && isset($words[$next])) {
            ...
            if ($resultLength == 0 && !preg_match("/^([ا آ أ إ ب پ ت ث ج چ ح خ د ذ ر ز ژ س ش ص ض ط ظ ع غ ف ق ک ك گ ل م ن و ؤ ه ة ی ي ئ ء ّ َ ِ ُ ً ٍ ٌ \. \/ \\ = \- \| \{ \} \[ \] ؛ : « » ؟ > < \+ \( \) \* ، × ٪ ٫ ٬ ! ۰۱۲۳۴۵۶۷۸۹٠١٢٣٤٥٦٧٨٩\x{200B}-\x{200D}\x{FEFF}\x{22}\x{27}\x{60}\x{B4}\x{2018}\x{2019}\x{201C}\x{201D}\x{201E}\x{201F}\x{2032}\x{2033}\s])+$/u", $word)) {
                continue;
            }
            // append the element
            $result[] = $word;
     ...
     * Language: Persian
     *
     * @see https://fa.wikisource.org/wiki/مدیر_مدرسه
     * @var string
     */
