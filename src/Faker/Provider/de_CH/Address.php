...
{
    protected static array $buildingNumber = ['###', '##', '#', '##[abc]', '#[abc]'];

    protected static array $streetSuffixLong = [
        'Gasse',
        'Platz',
        'Ring',
        'Strasse',
    ...
    protected static array $streetSuffixShort = [
        'gasse',
        'platz',
        'ring',
        'strasse',
    ...
    protected static array $canton = [
        ['AG' => 'Aargau'],
        ['AI' => "Appenzell\u{a0}Innerrhoden"],
        ['AR' => "Appenzell\u{a0}Ausserrhoden"],
        ['BE' => 'Bern'],
        ['BL' => 'Basel-Landschaft'],
        ['BS' => 'Basel-Stadt'],
        ['FR' => 'Freiburg'],
     ...
     * @example str.
     */
    public function streetSuffixShort(): string
    {
     ...
     * @example Strasse
     */
    public function streetSuffixLong(): string
    {
