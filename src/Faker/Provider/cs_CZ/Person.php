...
class Person extends \Faker\Provider\Person
{
     ...
     */
    public function birthNumber(?string $gender = null, int $minAge = 0, int $maxAge = 100, $slashProbability = 50): string
    {
        if (null === $gender) {
    ...
    public static function birthNumberMale(): string
    {
        return static::birthNumber(static::GENDER_MALE);
    }

    public static function birthNumberFemale(): string
    {
