...
{
    protected static $cityPrefix = array('North', 'East', 'West', 'South', 'New', 'Lake', 'Loch', 'Port');
    protected static $citySuffix = array('town', 'ton', 'land', 'ville', 'berg', 'burgh', 'borough', 'bury', 'view', 'port', 'mouth', 'stad', 'furt', 'chester', 'mouth', 'fort', 'haven', 'side', 'shire', 'grove');
