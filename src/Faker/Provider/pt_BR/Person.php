...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $titleMale = ['Sr.', 'Dr.'];

    protected static array $titleFemale = ['Sra.', 'Srta.', 'Dr.'];

    protected static array $suffix = ['Filho', 'Neto', 'Sobrinho', 'Jr.'];
     ...
     * @param bool $formatted If the number should have dots/dashes or not.
     */
    public function rg(bool $formatted = true): string
    {
        $n = $this->generator->numerify('########');
        $n .= check_digit($n);
