...
{
    protected static array $cityPrefix = ['São', 'Porto', 'Vila', 'Santa'];
    protected static array $citySuffix = ['do Norte', 'do Leste', 'do Sul', 'd\'Oeste'];
    ...
    protected static array $regionAbbr = [
        'CO',
        'N',
        'NE',
        'SE',
