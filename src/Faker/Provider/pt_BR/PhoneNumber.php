...
{
    protected static array $landlineFormats = ['2###-####', '3###-####', '4###-####'];
     ...
     */
    protected static array $cellphoneFormats = ['9####-####'];
     ...
     */
    public static function cellphone(bool $formatted = true): string
    {
     ...
     * @param bool $formatted [def: true] If it should return a formatted number or not.
     */
    public static function landline(bool $formatted = true): string
    {
     ...
     * @param bool $formatted [def: true] If it should return a formatted number or not.
     */
    public static function phone(bool $formatted = true)
    {
        ...
        return \call_user_func([__CLASS__, $options[0]], $formatted, $options[1]);
    }
     ...
     */
    protected static function anyPhoneNumber(string $type, bool $formatted = true): string
    {
        $area = static::areaCode();
        $number = ('cellphone' === $type) ?
     ...
     * @param bool $formatted [def: true] If it should return a formatted number or not.
     */
    public static function cellphoneNumber(bool $formatted = true): string
    {
     ...
     * @param bool $formatted [def: true] If it should return a formatted number or not.
     */
    public static function landlineNumber(bool $formatted = true): string
    {
    ...
    public function phoneNumber(): string
    {
        ...
        return \call_user_func([__CLASS__, $method], true);
    }
    ...
    public static function phoneNumberCleared()
    {
        ...
        return \call_user_func([__CLASS__, $method], false);
    }
}
