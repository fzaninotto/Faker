...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameFemale = array(
        ...
        'Ana Sofía', 'Andrea', 'Antonella', 'Antonia', 'Ariadna', 'Ariana', 'Bianca', 'Camila', 'Carla', 'Carolina', 'Catalina',
        'Catherine','Clara', 'Constanza', 'Daniela', 'Delfina', 'Elena', 'Elizabeth', 'Emilia', 'Emily', 'Emma', 'Fabiana', 'Florencia', 'Fátima',
