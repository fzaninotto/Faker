...
class Color extends \Faker\Provider\Color
{
    protected static $safeColorNames = array(
        'أسود', 'وردي', 'أخضر', 'أزرق داكن', 'أخضر غامق',
        'أرجواني', 'أحمر', 'أزرق', 'فضي',
    ...
    protected static $allColorNames = array(
        ...
        'أحمر جامعة بوسطن', 'أحمر حرس السواحل', 'أحمر داكن', 'أحمر ديبيان', 'أحمر صيني', 'أحمر اجوري', 'أحمر عقيقي',
        ...
        'أزرق جامعة كامبريدج', 'أخضر جيشي', 'أخضر دارتموثي', 'أخضر داكن', 'أخضر غابي', 'أخضر غابي داكن',
        'أخضر غابي عميق', 'أخضر ربيعي داكن', 'أخضر زيتوني داكن', 'أخضر سباقي بريطاني', 'أخضر سرخسي',
        ...
        'صبغة خشب الزان', 'صبغي النيلة', 'صحراوي', 'صفروي', 'صقيعي سيرولياني', 'صوفي', 'صوفي فرنسي', 'اجوري',
