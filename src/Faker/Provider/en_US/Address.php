...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $stateAbbr = array(
       'AS', 'GA', 'KS', 'MN', 'TX', 'UM', 'AK', 'AL', 'CO', 'KY', 'MP', 'NY', 'RI', 'SC', 'SD', 'WA', 'DC', 'GU', 'IA', 'OH', 'OR', 'CA', 'DE', 'HI', 'MA', 'MT', 'NC', 'NE', 'NJ', 'VI', 'CT', 'FL', 'IN', 'OK', 'UT', 'WI', 'WV', 'ID', 'IL', 'MD', 'ME', 'MO', 'MS', 'NM', 'PA', 'VT', 'WY', 'AZ', 'LA', 'ND', 'NH', 'NV', 'VA', 'AR', 'MI', 'PR', 'TN'
    );
