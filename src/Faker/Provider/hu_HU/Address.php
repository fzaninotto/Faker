...
class Address extends \Faker\Provider\Address
{
    ...
    protected static array $secondaryAddressFormats = ['##. emelet', '##. ajtó'];
     ...
     */
    protected static array $capitals = ['Budapest'];
    protected static array $bigCities = [
        'Békéscsaba',
        'Debrecen',
        'Dunaújváros',
        'Eger',
    ...
    protected static array $smallerCities = [
        'Ajka',
        'Aszód',
        'Bácsalmás',
        'Baja',
