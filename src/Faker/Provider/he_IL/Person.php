...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = array(
        ...
        'צבעון', 'צבר', 'צדוק', 'צדף', 'צדק', 'צדקיהו', 'צהל', 'צוף', 'צוק', 'צור', 'צוראל', 'צוריאל', 'צוריה', 'צח', 'צחי', 'צחר', 'ציון', 'צל', 'צלאל', 'צליל', 'צמח', 'צפניה', 'צפריר', 'קדוש', 'קדם',
        ...
        'שוני', 'שוע', 'שוקי', 'שור', 'שושן', 'שחם', 'שחף', 'שחק', 'שחר', 'שי', 'שי-אל', 'שילה', 'שילו', 'שי-לי', 'שיר', 'שירון', 'שירן', 'שלו', 'שלום', 'שלומי', 'שליו', 'שלמה', 'שלמון', 'שלמי', 'שם',
    ...
    protected static $firstNameFemale = array(
        ...
        'אילנית', 'אילת', 'השחר', 'חן', 'אינה', 'אינסה', 'אירה', 'איריס', 'אירית', 'איתי', 'אלדר', 'אלה', 'אלונה', 'אליאור', 'אליאל', 'אליאן', 'אליאנה', 'אליה', 'אלילה', 'אל-ים', 'אלין', 'אלינוי',
        ...
        'בשמת', 'בת', 'בת-אור', 'בת-אל', 'בת-גל', 'בת-גלים', 'בת-חיל', 'בת-חן', 'בתיה', 'בת-לי', 'בת-ציון', 'בת-שבע', 'בת-שחר', 'בת-שיר', 'גאולה', 'גאולית', 'גאות', 'גאיה', 'גאליה', 'גבית', 'גבריאלה',
        'גדעונה', 'גוני', 'גורה', 'גורית', 'גזית', 'גיא', 'גיה', 'גיטל', 'גיל', 'גילה', 'גילי', 'גילית', 'גילת', 'גינה', 'גינת', 'גיתית', 'גל', 'גלאור', 'גל-אור', 'גלי', 'גליה', 'גלילה', 'גליליה',
        ...
        'דוריאל', 'דוריה', 'דורין', 'דורינה', 'דורית', 'דורלי', 'דיאה', 'דיאנה', 'דיה', 'דין', 'דינה', 'דינור', 'דיצה', 'דיתה', 'דלית', 'דנה', 'דניאל', 'דניאלה', 'דניה', 'דנית', 'דעת',
        ...
        'חלומית', 'חלי', 'חמדה', 'חמדת', 'חמוטל', 'חנה', 'חני', 'חנית', 'חניתה', 'חן-לי', 'חסיה', 'חפצי-בה', 'חצבה', 'חרות', 'טאי', 'טארה', 'טהורה', 'טהר', 'טובה', 'טובית', 'טוהר', 'טופז', 'טימור', 'טינה',
        'טירה', 'טירנה', 'טל', 'טלאור', 'טל-אור', 'טל-חן', 'טלי', 'טליה', 'טלילה', 'טליתה', 'טללית', 'טל-שחר', 'טמירה', 'טנא', 'טניה', 'יאה', 'יאירה', 'יגאלה', 'ידידה', 'יהב', 'יהבה', 'יהודית',
        ...
        'לולה', 'לולית', 'לוריאן', 'לורין', 'לורן', 'לחן', 'לטיפה', 'ליאב', 'ליאה', 'ליאונור', 'ליאור', 'ליאורה', 'ליאל', 'לי-אל', 'ליאם', 'ליאן', 'ליאת', 'ליבה', 'ליבי', 'לי-בר', 'ליגל',
        'לידור', 'ליה', 'ליהי', 'ליהיא', 'ליז', 'לי-זר', 'לי-חן', 'ליטל', 'לי-ים', 'לילי', 'לילך', 'לין', 'לינדה', 'לינה', 'לינוי', 'לינור', 'ליפז', 'ליר', 'לירון', 'לירז', 'לירי', 'לי-שי', 'לנה',
        'לשם', 'מאור', 'מאורי', 'מאי', 'מאיה', 'מאירה', 'מארי', 'מבורכת', 'מדינה', 'מהות', 'מולדת', 'מוניק', 'מור', 'מוראל', 'מורג', 'מוריאל', 'מוריה', 'מורין', 'מורל', 'מורן', 'מושית', 'מזל', 'מטר',
        ...
        'מתנה', 'נאדיה', 'נאה', 'נאהב', 'נאוה', 'נאוית', 'נאור', 'נאורה', 'נאות', 'נאיה', 'נאמנה', 'נב', 'נבונה', 'נגבה', 'נגה', 'נגוהה', 'נגינה', 'נדיבה', 'נדין', 'נדירה', 'נהדרת', 'נהורה', 'נהירה',
        ...
        'נטע-לי', 'ניבה', 'ניבי', 'ניה', 'נילי', 'נילית', 'ניסן', 'ניצה', 'ניצן', 'ניצנה', 'ניצנית', 'ניקול', 'ניראל', 'נירה', 'נירי', 'נירית', 'נסיה', 'נסיכה', 'נעה', 'נעימה', 'נעם', 'נעמה', 'נעמי',
        ...
        'פז', 'פזית', 'פיוט', 'פלא', 'פלאית', 'פלג', 'פלד', 'פליאה', 'פניה', 'פנינה', 'פנינית', 'פסיה', 'פרח', 'פרחיה', 'פרחית', 'פרי', 'פריאור', 'פריאל', 'פריאלה', 'פרילי', 'פרימור', 'פשוש', 'צאלה',
        'צביאלה', 'צביה', 'צדף', 'צדפית', 'צדק', 'צדקה', 'צהלה', 'צוף', 'צופיה', 'צופית', 'צוקית', 'צוריה', 'צורית', 'צחה', 'צחורה', 'צחית', 'ציונה', 'צילה', 'צילי', 'צינה', 'ציפורן', 'צלחה',
        ...
        'רוחמה', 'רויה', 'רויטל', 'רוית', 'רומי', 'רומיה', 'רומית', 'רוממה', 'רון', 'רונה', 'רוני', 'רוניה', 'רונית', 'רונלי', 'רוננה', 'רות', 'רותם', 'רז', 'רזיאלה', 'רזיה', 'רזלי', 'רחל', 'רחלה',
        'ריבה', 'ריבי', 'ריטה', 'רים', 'רימון', 'רינה', 'רינת', 'רינתיה', 'ריף', 'רמה', 'רמונה', 'רמות', 'רמיה', 'רמית', 'רני', 'רנית', 'רנן', 'רננה', 'רננית', 'רעות', 'רעיה', 'רעננה', 'רעננית', 'רפאלה',
        ...
        'שלהבת', 'שלוה', 'שלווה', 'שלומית', 'שלי', 'שליו', 'שמחה', 'שמיים', 'שמרית', 'שמרת', 'שנהב', 'שני', 'שניר', 'שנית', 'שפי', 'שפירה', 'שפרה', 'שפרירה', 'שקד', 'שקמה', 'שקמונה', 'שרה', 'שרון',
