...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstName = array(
        'Sandra', 'Carmen', 'Mara', 'Cesar', 'Mario', 'Aaron', 'Diana', 'Jose Manuel', 'David', 'Alexandra', 'Ines', 'Noelia', 'Nerea', 'Miriam', 'Jose Antonio', 'Fernando', 'Gerard', 'Mireia', 'Daniel', 'Sofia', 'Lucas', 'Ander', 'Helena', 'Leire', 'Adrian', 'Noa', 'Fatima', 'Yeray', 'Pedro', 'Lidia', 'Paola', 'Jesus', 'Ainhoa', 'Iker', 'Laia', 'Eric', 'Isabel', 'Abril', 'Isaac', 'Pol', 'Alonso', 'Oliver', 'Manuela', 'Asier', 'Jose', 'Carlos', 'Alicia', 'Blanca', 'Natalia', 'Marina', 'Alejandra', 'Claudia', 'Alejandro', 'Aitor', 'Jorge', 'Ignacio', 'Salma', 'Marco', 'Zoe', 'Anna', 'Ane', 'Erik', 'Francisco', 'Biel', 'Pau', 'Erika', 'Berta', 'Izan', 'Raul', 'Carolina', 'Angel', 'Adria', 'Maria', 'Gabriel', 'Adam', 'Pablo', 'Sergio', 'Paula', 'Hugo', 'Leyre', 'Cristian', 'Dario', 'Alvaro', 'Vera', 'Luis', 'Carlota', 'Aleix', 'Nahia', 'Patricia', 'Vega', 'Marc', 'Manuel', 'Alma', 'Naia', 'Laura', 'Guillermo', 'Gabriela', 'Alex', 'Gael', 'Jana', 'Adriana', 'Julia', 'Jimena', 'Ruben', 'Rodrigo', 'Andres', 'Carla', 'Samuel', 'Beatriz', 'Arnau', 'Victoria', 'Jaime', 'Jon', 'Oriol', 'Aroa', 'Ariadna', 'Alexia', 'Nora', 'Lara', 'Andrea', 'Olivia', 'Irene', 'Martin', 'Mohamed', 'Lola', 'Joan', 'Leo', 'Clara', 'Bruno', 'Mar', 'Roberto', 'Jordi', 'Rayan', 'Nuria', 'Iria', 'Luna', 'Nayara', 'Rafael', 'Ismael', 'Naiara', 'Juan Jose', 'Nicolas', 'Cristina', 'Marcos', 'Celia', 'Francisco Javier', 'Juan', 'Unai', 'Omar', 'Lucia', 'Valentina', 'Aitana', 'Marti', 'Sara', 'Javier', 'Joel', 'Raquel', 'Aya', 'Santiago', 'Valeria', 'Saul', 'Diego', 'Jan', 'Miguel Angel', 'Victor', 'Angela', 'Elena', 'Marta', 'Ana', 'Oscar', 'Emma', 'Alba', 'Nadia', 'Eduardo', 'Elsa', 'Martina', 'Teresa', 'Guillem', 'Hector', 'Eva', 'Mateo', 'Yago', 'Yaiza', 'Gonzalo', 'Nil', 'Ainara', 'Africa', 'Ian', 'Aina', 'Ona', 'Alberto', 'Antonio', 'Silvia', 'Rocio', 'Candela', 'Daniela', 'Miguel', 'Enrique', 'Malak', 'Ivan'
    );
    ...
    // The data for male and female names is taken from the newborn names in 2012
    // http://www.ine.es/daco/daco42/nombyapel/nombyapel.htm
    protected static $firstNameMale = array(
        'Daniel', 'Hugo', 'Alejandro', 'Pablo', 'Alvaro', 'Adrian', 'David', 'Diego', 'Mario', 'Javier', 'Marcos', 'Manuel', 'Sergio', 'Nicolas', 'Iker', 'Lucas', 'Ivan', 'Carlos', 'Miguel', 'Jorge', 'Martin', 'Marc', 'Alex', 'Mateo', 'Gonzalo', 'Izan', 'Ruben', 'Antonio', 'Juan', 'Leo', 'Angel', 'Victor', 'Samuel', 'Aitor', 'Raul', 'Hector', 'Gabriel', 'Eric', 'Guillermo', 'Rodrigo', 'Adam', 'Dario', 'Jesus', 'Jose', 'Aaron', 'Jaime', 'Pedro', 'Alberto', 'Bruno', 'Joel', 'Francisco', 'Marco', 'Pau', 'Luis', 'Unai', 'Oscar', 'Rafael', 'Mohamed', 'Fernando', 'Ismael', 'Andres', 'Erik', 'Asier', 'Gerard', 'Ignacio', 'Alonso', 'Arnau', 'Pol', 'Biel', 'Cristian', 'Oliver', 'Rayan', 'Joan', 'Santiago', 'Marti', 'Jan', 'Miguel angel', 'Nil', 'Jose antonio', 'Isaac', 'Oriol', 'Roberto', 'Aleix', 'Enrique', 'Eduardo', 'Ian', 'Jose manuel', 'Ander', 'Jordi', 'Saul', 'Francisco javier', 'Yago', 'Cesar', 'Adria', 'Omar', 'Yeray', 'Gael', 'Jon', 'Mikel', 'Guillem'
    );

    protected static $firstNameFemale = array(
        'Lucia', 'Maria', 'Paula', 'Daniela', 'Sara', 'Carla', 'Martina', 'Sofia', 'Julia', 'Alba', 'Valeria', 'Claudia', 'Irene', 'Marta', 'Laura', 'Noa', 'Carmen', 'Adriana', 'Ainhoa', 'Elena', 'Ana', 'Aitana', 'Emma', 'Alejandra', 'Nerea', 'Marina', 'Ariadna', 'Ines', 'Laia', 'Andrea', 'Rocio', 'Ainara', 'Angela', 'Carlota', 'Jimena', 'Lola', 'Candela', 'Natalia', 'Celia', 'Valentina', 'Alicia', 'Leire', 'Blanca', 'Nora', 'Eva', 'Clara', 'Cristina', 'Victoria', 'Aroa', 'Leyre', 'Vega', 'Olivia', 'Nuria', 'Carolina', 'Noelia', 'Isabel', 'Aina', 'Alma', 'Lara', 'Abril', 'Elsa', 'Mar', 'Miriam', 'Vera', 'Gabriela', 'Naiara', 'Silvia', 'Berta', 'Helena', 'Aya', 'Sandra', 'Erika', 'Naia', 'Manuela', 'Iria', 'Africa', 'Raquel', 'Mireia', 'Paola', 'Mara', 'Anna', 'Alexia', 'Nayara', 'Patricia', 'Zoe', 'Nahia', 'Salma', 'Malak', 'Diana', 'Nadia', 'Iris', 'Jana', 'Ane', 'Lidia', 'Chloe', 'Arlet', 'Ona', 'Irati', 'Judith', 'Luna'
    );
