...
class Address extends \Faker\Provider\Address
{
    ...
    private static $regions = array(
        ...
        'Cavally', 'Folon', 'Gbêkê', 'Gbôklé', 'Gôh',
        'Gontougo', 'Grands Ponts', 'Guémon', 'Hambol', 'Haut-Sassandra',
        'Iffou', 'Indénié-Djuablin', 'Kabadougou', 'Lôh-Djiboua', '	Marahoué',
        'Mé', 'Moronou', 'Nawa', 'N’zi', 'Poro', 'San-Pédro',
        'Sud-Comoé', 'Tchologo', 'Tonkpi', 'Worodougou', 'Yamoussoukro'
    );
    ...
    /**
     * Randomly returns a ivorian region.
     *
     * @example 'Tchologo'
     *
     * @return string
