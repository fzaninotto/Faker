...
{
    protected static array $streetPrefix = ['شارع'];

    protected static array $cityPrefix = ['شمال', 'شرق', 'غرب', 'جنوب', 'وسط'];
    ...
    protected static array $secondaryAddressFormats = ['شقة رقم. ##', 'بناية رقم ##'];
