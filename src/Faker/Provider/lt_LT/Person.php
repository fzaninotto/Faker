...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $titleMale = ['p.', 'ponas'];

    protected static array $titleFemale = ['p.', 'ponia', 'panelė'];
     ...
     * @example 12345678
     */
    public function driverLicence(): string
    {
        return self::bothify('########');
    }
     ...
     */
    public function personalIdentityNumber(string $gender = 'male', ?\DateTime $birthdate = null, string $randomNumber = ''): string
    {
        if (!$birthdate) {
            $birthdate = \Faker\Provider\DateTime::dateTimeThisCentury();
        }

        $genderNumber = ('male' === $gender) ? 1 : 0;
        ...
        $lastNumber = (10 !== $liekana) ? $liekana : 0;
     ...
     * @param int $time [1|2]
     */
    private static function calculateSum(string $numbers, int $time = 1): int
    {
        if (1 === $time) {
