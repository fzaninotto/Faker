...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $companyModifier = array(
        '网络', '信息', '传媒', '生物', '百货', '酒店', '汽车',
        '科技', '电脑', '国际', '电子', '娱乐', '音乐', '唱片',
        '证券', '集团', '企业', '机械', '工业', '文化', '软件'
    );
    ...
    protected static $jobs = array(
            '开发工程师', '测试工程师', '全栈工程师', '运维工程师', '系统工程师',
            '产品实习生', '无线产品设计师', '网页产品设计师', '产品部经理', '游戏制作人',
            '产品总监', '秘书', '业务经理', '运维总监', '网页设计师', '网页设计师',
            '游戏策划', '广告设计师', '数据分析师', '交互设计师', '副主编', '主编',
            '售后客服', '财务', '出纳', '财务总监', '法务'
    );
    ...
    public function job()
    {
        return static::randomElement(static::$jobs);
    }
}
