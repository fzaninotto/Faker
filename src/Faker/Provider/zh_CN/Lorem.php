...
class Lorem extends \Faker\Provider\Lorem
{
    protected static $wordListCN = array(
        ...
        '传言玉女', '小镇西苑', '临江仙引', '诉衷情近', '卓牌子近', '月上海棠', '蕙兰芳引', '鱼游春水', '卜算子慢',
        '上林春令', '麦秀两岐', '花上月令', '献天寿令', '孤馆深沉', '黄鹤洞仙', '蕙兰芳引', '鱼游春水', '卜算子慢',
        '侍香金童', '二色宫桃', '木兰花令', '浪淘沙令', '烛影摇红', '霜天晓角', '千秋岁引', '南州春色', '望云涯引',
        '秋蕊香引', '隔溪梅令', '伊州三台', '双头莲令', '法驾导引', '相思儿令', '婆罗门引', '红林檎近', '阜罗特髻', 
        '雨中花令', '彩鸾归令', '诉衷情令', '步虚子令', '金盏子令', '祝英台近', '无愁可解', '江城子慢', '江南春慢'
     ...
     * @param   boolean $variableNbSentences      如果你想要 $nbWords 准确返回值,请设置为假,
     *                                          否则 $nbWords 会有 +/-40% 浮动并且最小值为 1
     * @return  string
     */
