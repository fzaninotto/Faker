...
class Lorem extends \Faker\Provider\Lorem
{
    protected static $wordListCn = array(
        ...
        '传言玉女', '小镇西苑', '临江仙引', '诉衷情近', '卓牌子近', '月上海棠', '无愁可解', '江城子慢',
        '上林春令', '麦秀两岐', '花上月令', '献天寿令', '孤馆深沉', '黄鹤洞仙', '蕙兰芳引', '鱼游春水',
        '侍香金童', '二色宫桃', '木兰花令', '浪淘沙令', '烛影摇红', '霜天晓角', '千秋岁引', '南州春色',
        '秋蕊香引', '隔溪梅令', '伊州三台', '双头莲令', '法驾导引', '相思儿令', '婆罗门引', '红林檎近', 
