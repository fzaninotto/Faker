...
class Person extends \Faker\Provider\Person
{
    ...
    protected static array $titleMale = ['Sr.', 'Dn.', 'Dr.', 'Lcdo.', 'Ing.'];

    protected static array $titleFemale = ['Sra.', 'Srita.', 'Dra.', 'Lcda.', 'Ing.'];

    private static array $suffix = ['Hijo'];

    private static array $nationalityId = ['V', 'E'];
     ...
     * @see http://www.cne.gob.ve/web/registro_electoral/ciudadanos_111_129_2011.php
     */
    public function nationalId(string $separator = ''): string
    {
        $id = static::randomElement(static::$nationalityId);
        if ('V' === $id) {
            return $id.$separator.self::numberBetween(10000, 100000000);
        }

        return $id.$separator.self::numberBetween(80000000, 100000000);
    }
}
