...
class Company extends \Faker\Provider\Company
{
    ...
    protected static array $companyPrefix = ['ТОВ', 'ПП', 'ПАТ', 'ПрАТ'];
    protected static array $companySuffix = ['Сервіс', 'Плюс', 'Груп', 'Стиль', 'Дизайн'];

    protected static array $companyName = [
        'Вектор',
        'Едельвейс',
        'Смарт',
        'Альфа',
