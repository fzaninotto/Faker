...
class AddressTest extends TestCase
{
  ...
  /**
   * Test the format of Canadian postcode
   */
  public function testPostcodeFormat()
  {
  ...
  /**
   * Test validity of Canadian postcode
   */
  public function testPostcodeValidity()
  {
    $postcode = $this->faker->validpostcode();
    $this->assertNotEmpty($postcode);
    $this->assertInternalType('string', $postcode);
    $this->assertRegExp('/^[^DFIOQUWZ]\d[^DFIOQU] \d[^DFIOQU]\d$/', $postcode);
  }
}
